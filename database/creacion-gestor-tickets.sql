...
--
-- Host: 192.168.1.143    Database: gestor_tickets
-- ------------------------------------------------------
...
CREATE TABLE `tickets` (
  ...
  `state` enum('resuelto','no') DEFAULT 'no',
  ...
  CONSTRAINT `fk_tech` FOREIGN KEY (`id_tech`) REFERENCES `technicians` (`id_tech`),
...
--
-- Dumping routines for database 'gestor_tickets'
--
...
-- Dump completed on 2026-03-23 12:16:03
